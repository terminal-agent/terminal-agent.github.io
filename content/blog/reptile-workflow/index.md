...
#   blur: false
---
{{< button href="https://github.com/Sailor-Agents/Terminal-Agents" label="GITHUB" external=true >}}
...
![image](https://hackmd.io/_uploads/SkGiD2BWWl.png)
...
<img src="https://hackmd.io/_uploads/SyKX2MTMWg.png" width="50%">
...
# Technical Details in Building Terminal-based Agent
...
For technique details in tty-use, please see our post at https://tinyurl.com/vrwcmpks and https://x.com/mavenlin/status/1977758827366817929.
...
See annotation example in https://github.com/Sailor-Agents/yaml_data_valid/blob/ba20c0400f4428436721bcc589bef801df2ec1ae/history.yml#L43.

<img src="https://hackmd.io/_uploads/r1G2tMpG-g.png" width="70%">


Please refer to https://reptile.github.io/blog/annotation/ for more annotation details and more experiments


### Data Collection Workflow


<img src="https://hackmd.io/_uploads/SyRziFHWWl.png" width="50%">
...
We've built an **Agent Gym** that provides a structured environment for reinforcement learning.
...
Visit our GitHub repository: [https://github.com/Sailor-Agents/Terminal-Agents](https://github.com/Sailor-Agents/Terminal-Agents)
...
- Continuously improves through multiple learning signals
...
```bibtex
@misc{reptile2025agent,
  title={Reptile: Terminal-Agent with REPL-based Human-in-the-loop Learning},
  author={Dou, Longxu and Du, Cunxiao and Li, Shenggui and Zhang, Tianjie and Wang, Tianduo and Liu, Tianyu and Chen, Xianwei and Tang, Chenxia and Zhao, Yuanheng and Lin, Min},
  year={2025},
  howpublished={\url{https://sailor-agents.github.io/blog/reptile-terminal-agent/}},
  note={Blog}
}
```
